...
Widget buildPressRelease(context) {
  return Expanded(
    child: GetBuilder<HomeController>(builder: (_controller) {
      return !_controller.isLoadedPressReelase
          ? Center(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: TextFormField(
                            onChanged: (value) {
                              _controller.searchPressRelease(value);
                            },
                ...
                Expanded(
                  child: Container(
                      ...
                      child: TPaginatedDataTable(
                        ...
                        rowsPerPage: 10,
                        source: MyDataSource(_controller.pressDataList),
                      )),
                )
              ],
            );
...
class MyDataSource extends DataTableSource {
  final List<PressReleaseModelData> data;
